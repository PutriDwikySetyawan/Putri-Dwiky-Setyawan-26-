...
class Program
{
    static void Main()
    {
        ...
        string[] makanan = { "Nasi Goreng", "Nasi Uduk", "Nasi Kucing", "Mie Rebus", "Mie Goreng", "Mie Ayam" ,"Ayam Geprek" ,"Bakso","Mie Jebew"};
        double[] hargaMakanan = { 12000, 9000, 6000, 7000, 8000, 10000, 9000 , 6000 , 7000 };

        // Array untuk daftar minuman dan harga
        string[] minuman = { "Teh Botol", "Teh Pucuk", "Susu Jahe", "Kopi Jahe", "Kopi Susu", "Tea Jus" , "Jus Alpukat" , "Es Boba" , "Smoothies Mangga"};
        double[] hargaMinuman = { 5000, 4000, 3000, 3000, 5000, 0 , 10000, 12000 ,14000}; // Tea Jus gratis
